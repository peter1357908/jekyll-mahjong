Gem::Specification.new do |s|
  ...
  s.description = '"jekyll-mahjong" is a Jekyll plugin that offers a "mahjong" tag that will translate the text notation like "123p444s" into vector graphics of mahjong tiles. For demo and documentation, please see here: https://peterish.com/riichi-docs/jekyll-mahjong-plugin/.'
  s.authors     = ['Peter Gao']
