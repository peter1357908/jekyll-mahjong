Gem::Specification.new do |s|
  ...
  s.description = '"jekyll-mahjong" is a Jekyll plugin that offers a "mahjong" tag that will translate the text notation like "123p444s" into vector graphics of mahjong tiles.'
  s.authors     = ['Peter Gao']
  s.email       = 'peter1357908@hotmail.com'
  s.files       = Dir['lib/*.rb'] + Dir['assets/tiles/*.svg']
  s.homepage    = 'https://peterish.com/programming/jekyll-mahjong-plugin/'
